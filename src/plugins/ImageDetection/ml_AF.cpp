...
MLImageDetection::AutoFocus::AutoFocus()
{
}
...
// Brenner
double MLImageDetection::AutoFocus::brenner(cv::Mat &image)
{
    //	assert(image.empty());
...
//Tenengrad
double MLImageDetection::AutoFocus::tenengard(cv::Mat &image)
{
    // assert(image.empty());
...
//smd
double MLImageDetection::AutoFocus::smd(cv::Mat &image)
{
    // assert(image.empty());
...
double MLImageDetection::AutoFocus::smd2(cv::Mat &image)
{
    // assert(image.empty());
...
double MLImageDetection::AutoFocus::blur_noise_IQA(cv::Mat &image)
{
    // assert(image.empty());

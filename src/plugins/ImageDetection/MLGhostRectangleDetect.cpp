...
using namespace cv;
MLImageDetection::GhostRectangleDetect::GhostRectangleDetect()
{
}
...
GhostRectRe MLImageDetection::GhostRectangleDetect::getGhostRectangleRect(const cv::Mat img, cv::Rect rect)
{
...
vector<cv::Rect> MLImageDetection::GhostRectangleDetect::findRectangleByContour(cv::Mat img, cv::Mat& imgdraw,cv::Rect rectBoun)
{
...
vector<cv::Rect> MLImageDetection::GhostRectangleDetect::findRectangleByTemplate(cv::Mat img, cv::Mat& imgdraw, cv::Rect rectBoun)
{
...
cv::Mat MLImageDetection::GhostRectangleDetect::preProcess(cv::Mat img)
{
...
vector<cv::Point> MLImageDetection::GhostRectangleDetect::matchTemplateMaxLocs(cv::Mat img, cv::Mat templ, double score, int bin)
{
...
void MLImageDetection::GhostRectangleDetect::getSortData(vector<cv::Rect> rectVec, vector<cv::Rect>& rectVecSort)
{

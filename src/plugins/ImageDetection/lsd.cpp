...
/** Scale the input image 'in' by a factor 'scale' by Gaussian sub-sampling.
    ...
    A fast MLImageDetection is done using the separability of the Gaussian
    ...
    @f]
    The MLImageDetection first apply a combined Gaussian kernel and sampling
    ...
    for (; list_p != NULL; list_p = list_p->next )
               ...
               because we are only interested in the exact NOTDEF value */
        {
            ...
            /* Check if the rectangle exceeds the minimal density of
               ...
               This is an addition to the original LSD MLImageDetection published in
               "LSD: A Fast Line Segment Detector with a False Detection Control"
               by R. Grompone von Gioi, J. Jakubowicz, J.M. Morel, and G. Randall.
               The original MLImageDetection is obtained with density_th = 0.0.
             */

...
static const QIcon &icon(IconIndex icon)
{
    switch (icon) {
    case OkIcon: {
        static const QIcon ok = QIcon(":/image/images/ok.png");
        return ok;
    }
    case ErrorIcon: {
        static const QIcon error = QIcon(":/image/images/eror.png");
        return error;
    }
    default:
    case NotLoadedIcon: {
        static const QIcon notLoaded = QIcon(":/image/images/broken.png");
        return notLoaded;
    }
    }
}

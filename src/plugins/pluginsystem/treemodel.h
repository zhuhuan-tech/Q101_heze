...
class PLUGINSYSTEM_EXPORT TreeItem
{
public:
    TreeItem();
    virtual ~TreeItem();
...
class PLUGINSYSTEM_EXPORT StaticTreeItem : public TreeItem
{
public:
...
class PLUGINSYSTEM_EXPORT BaseTreeModel : public QAbstractItemModel
{
    Q_OBJECT

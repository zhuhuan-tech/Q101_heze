...
ManhattanStylePrivate::ManhattanStylePrivate() :
    extButtonIcon(QPixmap(":/image/images/extension.png")),
    closeButtonPixmap(QPixmap(":/image/images/close.png"))
{
}
                                             ...
                                             QPainter *painter, const QWidget *widget)
{
    ...
    case QStyle::PE_IndicatorTabClose: {
        ...
        const static QIcon closeIcon(":/image/images/close.png");
    ...
    case PE_PanelLineEdit:
        {
            ...
            if (creatorTheme()->flag(Theme::FlatToolBars)) {
                ...
                static const QImage bg(StyleHelper::dpiSpecificImageFile(
                                           QLatin1String(":/image/images/inputfield.png")));
                static const QImage bg_disabled(StyleHelper::dpiSpecificImageFile(
                                                    QLatin1String(":/image/images/inputfield_disabled.png")));

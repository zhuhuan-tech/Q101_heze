...
RightPanePlaceHolder::RightPanePlaceHolder(QString mode, QWidget *parent) : QWidget(parent), m_mode(mode)
{
    setLayout(new QVBoxLayout);
    layout()->setContentsMargins(0, 0, 0, 0);
    // connect(ModeManager::instance(), &ModeManager::currentModeChanged, this,
    // &RightPanePlaceHolder::currentModeChanged);
}
...
void RightPanePlaceHolder::currentModeChanged(QString mode)
{
    if (m_current == this)
    {
        m_current = nullptr;

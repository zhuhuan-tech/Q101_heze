...
Q_DECLARE_METATYPE(Core::MenuActionContainer*)
...
ActionContainerPrivate::ActionContainerPrivate(QString id)
...
void ActionContainerPrivate::appendGroup(QString groupId)
{
    m_groups.append(Group(groupId));
}

void ActionContainerPrivate::insertGroup(QString before, QString groupId)
{
...
QList<Group>::const_iterator ActionContainerPrivate::findGroup(QString groupId) const
{
...
QAction *ActionContainerPrivate::insertLocation(QString groupId) const
{
...
void ActionContainerPrivate::addAction(Command *command, QString groupId)
{
    if (!canAddAction(command))
        return;

    const QString actualGroupId = !groupId.isEmpty() ? groupId : QString(Constants::G_DEFAULT_TWO);
...
void ActionContainerPrivate::addMenu(ActionContainer *menu, QString groupId)
{
...
Command *ActionContainerPrivate::addSeparator(const Context &context, QString group, QAction **outSeparator)
{
    static int separatorIdCount = 0;
    auto separator = new QAction(this);
    separator->setSeparator(true);
    QString sepId = id()+".Separator."+QString::number(++separatorIdCount);
...
QString ActionContainerPrivate::id() const
{
    return m_id;
}
...
*/
Command *ActionContainer::addSeparator(QString group)
{

...
/*!
    ...
    the specified \a QString. The ActionManager owns the returned ActionContainer.
...
*/
Command *ActionManager::registerAction(QAction *action, QString id, const Context &context, bool scriptable)
{
...
*/
void ActionManager::unregisterAction(QAction *action, QString id)
{
...
Action *ActionManagerPrivate::overridableAction(QString id)
{

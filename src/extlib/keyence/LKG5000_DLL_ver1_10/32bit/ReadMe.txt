...
(2) File and folder configuration
  ...
  LkIF2.BAS             - A header file for using the program from VB.
  ...
  Samples folder        - Contains sample codes used to invoke the program from VB or VC++.
                          Use these codes if necessary.


(3) The USB driver for LK-Navigator 2 must be installed.


(4) This DLL includes the DLL interfaces for the LK-G3000 Series, however, this DLL is designed 
    for the K-G5000 Series and the operation with the LK-G3000 Series is not guaranteed.

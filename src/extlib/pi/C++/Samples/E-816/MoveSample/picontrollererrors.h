...
//
// (C) Copyright 2004-2012 by Physik Instrumente (PI) GmbH & Co. KG
//
...
#define PI_ERROR_PAM_FILE_HAS_DUPLICATE_ENTRY_WITH_DIFFERENT_VALUES -1109L  /**< \ingroup err
        PAM file has duplicate entry with different values. */
#define PI_ERROR_FILE_NO_SIGNATURE__MINUS1110 -1110L
#define PI_ERROR_FILE_NO_SIGNATURE -1110L  /**< \ingroup err
        File has no signature */
#define PI_ERROR_FILE_INVALID_SIGNATURE__MINUS1111 -1111L
#define PI_ERROR_FILE_INVALID_SIGNATURE -1111L  /**< \ingroup err
...
#define PI_ERROR_CANNOT_DETERMINE_ACTUAL_END_OF_TRAVEL_WHILE_PLATFORM_IS_MOVING -1112L  /**< \ingroup err
        Cannot determine actual end of travel range while platform is moving. */
#define PI_PARAMETER_DB_INVALID_STAGE_TYPE_FORMAT__MINUS10000 -10000L
#define PI_PARAMETER_DB_INVALID_STAGE_TYPE_FORMAT -10000L  /**< \ingroup err
...
#define PI_PARAMETER_DB_SYSTEM_NOT_AVAILABLE -10001L  /**< \ingroup err
        PI stage database: Database does not contain the selected stage type for the connected controller. */
#define PI_PARAMETER_DB_FAILED_TO_ESTABLISH_CONNECTION__MINUS10002 -10002L
#define PI_PARAMETER_DB_FAILED_TO_ESTABLISH_CONNECTION -10002L  /**< \ingroup err
        PI stage database: Establishing the connection has failed. */
#define PI_PARAMETER_DB_COMMUNICATION_ERROR__MINUS10003 -10003L
#define PI_PARAMETER_DB_COMMUNICATION_ERROR -10003L  /**< \ingroup err
...
#define PI_PARAMETER_DB_ERROR_WHILE_QUERYING_PARAMETERS -10004L  /**< \ingroup err
        PI stage database: Querying data failed. */
#define PI_PARAMETER_DB_SYSTEM_ALREADY_EXISTS__MINUS10005 -10005L
#define PI_PARAMETER_DB_SYSTEM_ALREADY_EXISTS -10005L  /**< \ingroup err
...
#define PI_PARAMETER_DB_QHPA_CONTANS_UNKNOWN_PAM_IDS -10006L  /**< \ingroup err
...
#define PI_PARAMETER_DB_AND_QHPA_ARE_INCONSISTENT -10007L  /**< \ingroup err
...
#define PI_PARAMETER_DB_SYSTEM_COULD_NOT_BE_ADDED -10008L  /**< \ingroup err
        PI stage database: Stage has not been added. */
#define PI_PARAMETER_DB_SYSTEM_COULD_NOT_BE_REMOVED__MINUS10009 -10009L
#define PI_PARAMETER_DB_SYSTEM_COULD_NOT_BE_REMOVED -10009L  /**< \ingroup err
        PI stage database: Stage has not been removed. */
#define PI_PARAMETER_DB_CONTROLLER_DB_PARAMETERS_MISMATCH__MINUS10010 -10010L
#define PI_PARAMETER_DB_CONTROLLER_DB_PARAMETERS_MISMATCH -10010L  /**< \ingroup err
        Controller does not support all stage parameters stored in PI stage database. No parameters were set. */
#define PI_PARAMETER_DB_DATABASE_IS_OUTDATED__MINUS10011 -10011L
#define PI_PARAMETER_DB_DATABASE_IS_OUTDATED -10011L  /**< \ingroup err
        The version of PISTAGES3.DB stage database is out of date. Please update via PIUpdateFinder. No parameters were set. */
#define PI_PARAMETER_DB_AND_HPA_MISMATCH_STRICT__MINUS10012 -10012L
#define PI_PARAMETER_DB_AND_HPA_MISMATCH_STRICT -10012L  /**< \ingroup err
        Mismatch between number of parameters present in stage database and available in controller interface. No parameters were set. */
#define PI_PARAMETER_DB_AND_HPA_MISMATCH_LOOSE__MINUS10013 -10013L
#define PI_PARAMETER_DB_AND_HPA_MISMATCH_LOOSE -10013L  /**< \ingroup err
        Mismatch between number of parameters present in stage database and available in controller interface. Some parameters were ignored. */
#define PI_PARAMETER_DB_FAILED_TO_SET_PARAMETERS_CORRECTLY__MINUS10014 -10014L
#define PI_PARAMETER_DB_FAILED_TO_SET_PARAMETERS_CORRECTLY -10014L  /**< \ingroup err
...
#define PI_PARAMETER_DB_MISSING_PARAMETER_DEFINITIONS_IN_DATABASE -10015L  /**< \ingroup err
        One or more parameter definitions are not present in stage database. Please update PISTAGES3.DB via PIUpdateFinder. Missing parameters were ignored. */
//
//  End of Dll Errors
//////////////////////////////////////////////////
...
#define PI_CNTR_DYNAMIC_MOVE_IN_PROCESS 53L  /**< \ingroup err
        Command is not allowed while the affected axis is in motion. */
...
#define PI_CNTR_INVALID_VALUE_LENGTH 97L  /**< \ingroup err
        Invalid length of value (too much characters) */
#define PI_CNTR_AUTOZERO_FAILED__98 98L
#define PI_CNTR_AUTOZERO_FAILED 98L  /**< \ingroup err
        AutoZero procedure was not successful */
#define PI_CNTR_SENSOR_VOLTAGE_OFF__99 99L
#define PI_CNTR_SENSOR_VOLTAGE_OFF 99L  /**< \ingroup err
        Sensor voltage is off */
...
#define PI_CNTR_INTERPOLATION_FIFO_UNDERRUN 220L  /**< \ingroup err
        FIFO buffer underrun during interpolation */
#define PI_CNTR_INTERPOLATION_FIFO_OVERFLOW__221 221L
#define PI_CNTR_INTERPOLATION_FIFO_OVERFLOW 221L  /**< \ingroup err
        FIFO buffer overflow during interpolation */
...
#define PI_CNTR_LOST_SPI_SLAVE_CONNECTION 507L  /**< \ingroup err
        digital connection to external spi slave device is lost */
#define PI_CNTR_MOVE_ATTEMPT_NOT_PERMITTED__508 508L
#define PI_CNTR_MOVE_ATTEMPT_NOT_PERMITTED 508L  /**< \ingroup err
        Move attempt not permitted due to customer or limit settings */
#define PI_CNTR_TRIGGER_EMERGENCY_STOP__509 509L
#define PI_CNTR_TRIGGER_EMERGENCY_STOP 509L  /**< \ingroup err
        Emergency stop caused by trigger input */
#define PI_CNTR_CS_DOES_NOT_EXIST__530 530L
#define PI_CNTR_CS_DOES_NOT_EXIST 530L  /**< \ingroup err
        A command refers to a coordinate system that does not exist */
#define PI_CNTR_PARENT_CS_DOES_NOT_EXIST__531 531L
#define PI_CNTR_PARENT_CS_DOES_NOT_EXIST 531L  /**< \ingroup err
        A command refers to a coordinate system that has no parent node */
#define PI_CNTR_CS_IN_USE__532 532L
#define PI_CNTR_CS_IN_USE 532L  /**< \ingroup err
        Attempt to delete or change a coordinate system that is in use */
#define PI_CNTR_CS_DEFINITION_IS_CYCLIC__533 533L
#define PI_CNTR_CS_DEFINITION_IS_CYCLIC 533L  /**< \ingroup err
        Definition of a coordinate system is cyclic */
#define PI_CNTR_HEXAPOD_IN_MOTION__536 536L
#define PI_CNTR_HEXAPOD_IN_MOTION 536L  /**< \ingroup err
        Coordinate system cannot be defined as long as Hexapod is in motion */
#define PI_CNTR_CS_TYPE_CANNOT_BE_ENABLED__537 537L
#define PI_CNTR_CS_TYPE_CANNOT_BE_ENABLED 537L  /**< \ingroup err
        Coordinate system type is not intended for manual enabling */
#define PI_CNTR_CS_PARENT_IDENTICAL_TO_CHILD__539 539L
#define PI_CNTR_CS_PARENT_IDENTICAL_TO_CHILD 539L  /**< \ingroup err
        A coordinate system cannot be linked to itself */
#define PI_CNTR_CS_DEFINITION_INCONSISTENT__540 540L
#define PI_CNTR_CS_DEFINITION_INCONSISTENT 540L  /**< \ingroup err
        Coordinate system definition is erroneous or not complete (replace or delete it) */
#define PI_CNTR_CS_NOT_IN_SAME_CHAIN__542 542L
#define PI_CNTR_CS_NOT_IN_SAME_CHAIN 542L  /**< \ingroup err
        The coordinate systems are not part of the same chain */
#define PI_CNTR_CS_MEMORY_FULL__543 543L
#define PI_CNTR_CS_MEMORY_FULL 543L  /**< \ingroup err
        Unused coordinate system must be deleted before new coordinate system can be stored */
#define PI_CNTR_SPI_COMMAND_NOT_SUPPORTED__544 544L
#define PI_CNTR_SPI_COMMAND_NOT_SUPPORTED 544L  /**< \ingroup err
        With this coordinate system type SPI usage is not supported */
#define PI_CNTR_SOFTLIMITS_INVALID__545 545L
#define PI_CNTR_SOFTLIMITS_INVALID 545L  /**< \ingroup err
        Soft limits invalid due to changes in coordinate system */
#define PI_CNTR_CS_WRITE_PROTECTED__546 546L
#define PI_CNTR_CS_WRITE_PROTECTED 546L  /**< \ingroup err
        Coordinate system is write protected */
#define PI_CNTR_CS_CONTENT_FROM_CONFIG_FILE__547 547L
#define PI_CNTR_CS_CONTENT_FROM_CONFIG_FILE 547L  /**< \ingroup err
...
#define PI_CNTR_CS_CANNOT_BE_LINKED 548L  /**< \ingroup err
        Coordinate system may not be linked */
#define PI_CNTR_KSB_CS_ROTATION_ONLY__549 549L
#define PI_CNTR_KSB_CS_ROTATION_ONLY 549L  /**< \ingroup err
...
#define PI_CNTR_CS_TYPE_NOT_ENABLED 556L  /**< \ingroup err
        No coordinate system of this type is enabled */
#define PI_CNTR_CS_NAME_INVALID__557 557L
#define PI_CNTR_CS_NAME_INVALID 557L  /**< \ingroup err
        Name of coordinate system is invalid */
#define PI_CNTR_CS_GENERAL_FILE_MISSING__558 558L
#define PI_CNTR_CS_GENERAL_FILE_MISSING 558L  /**< \ingroup err
        File with stored CS systems is missing or erroneous */
#define PI_CNTR_CS_LEVELING_FILE_MISSING__559 559L
#define PI_CNTR_CS_LEVELING_FILE_MISSING 559L  /**< \ingroup err
        File with leveling CS is missing or erroneous */
...
#define PI_CNTR_FAST_ALIGNMENT_PROCESS_IS_NOT_RUNNING 608L  /**< \ingroup err
...
#define PI_CNTR_FAST_ALIGNMENT_PROCESS_IS_NOT_PAUSED 609L  /**< \ingroup err
...
#define PI_CNTR_UNABLE_TO_SET_PARAM_WITH_SPA 650L  /**< \ingroup err
        Parameter could not be set with SPA - SEP needed? */
#define PI_CNTR_PHASE_FINDING_ERROR__651 651L
#define PI_CNTR_PHASE_FINDING_ERROR 651L  /**< \ingroup err
        Phase finding error */
#define PI_CNTR_SENSOR_SETUP_ERROR__652 652L
#define PI_CNTR_SENSOR_SETUP_ERROR 652L  /**< \ingroup err
        Sensor setup error */
#define PI_CNTR_SENSOR_COMM_ERROR__653 653L
#define PI_CNTR_SENSOR_COMM_ERROR 653L  /**< \ingroup err
        Sensor communication error */
#define PI_CNTR_MOTOR_AMPLIFIER_ERROR__654 654L
#define PI_CNTR_MOTOR_AMPLIFIER_ERROR 654L  /**< \ingroup err
        Motor amplifier error */
#define PI_CNTR_OVER_CURR_PROTEC_TRIGGERED_BY_I2T__655 655L
#define PI_CNTR_OVER_CURR_PROTEC_TRIGGERED_BY_I2T 655L  /**< \ingroup err
        Overcurrent protection triggered by I2T-module */
#define PI_CNTR_OVER_CURR_PROTEC_TRIGGERED_BY_AMP_MODULE__656 656L
#define PI_CNTR_OVER_CURR_PROTEC_TRIGGERED_BY_AMP_MODULE 656L  /**< \ingroup err
        Overcurrent protection triggered by amplifier module */
#define PI_CNTR_SAFETY_STOP_TRIGGERED__657 657L
#define PI_CNTR_SAFETY_STOP_TRIGGERED 657L  /**< \ingroup err
        Safety stop triggered */
#define PI_SENSOR_OFF__658 658L
#define PI_SENSOR_OFF 658L  /**< \ingroup err
        Sensor off? */
#define PI_CNTR_PARAM_CONFLICT__659 659L
#define PI_CNTR_PARAM_CONFLICT 659L  /**< \ingroup err
        Parameter could not be set. Conflict with another parameter. */
#define PI_CNTR_COMMAND_NOT_ALLOWED_IN_EXTERNAL_MODE__700 700L
#define PI_CNTR_COMMAND_NOT_ALLOWED_IN_EXTERNAL_MODE 700L  /**< \ingroup err
        Command not allowed in external mode */
#define PI_CNTR_EXTERNAL_MODE_ERROR__710 710L
#define PI_CNTR_EXTERNAL_MODE_ERROR 710L  /**< \ingroup err
        External mode communication error */
#define PI_CNTR_INVALID_MODE_OF_OPERATION__715 715L
#define PI_CNTR_INVALID_MODE_OF_OPERATION 715L  /**< \ingroup err
        Invalid mode of operation */
#define PI_CNTR_FIRMWARE_STOPPED_BY_CMD__716 716L
#define PI_CNTR_FIRMWARE_STOPPED_BY_CMD 716L  /**< \ingroup err
        Firmware stopped by command (#27) */
#define PI_CNTR_EXTERNAL_MODE_DRIVER_MISSING__717 717L
#define PI_CNTR_EXTERNAL_MODE_DRIVER_MISSING 717L  /**< \ingroup err
        External mode driver missing */
#define PI_CNTR_CONFIGURATION_FAILURE_EXTERNAL_MODE__718 718L
#define PI_CNTR_CONFIGURATION_FAILURE_EXTERNAL_MODE 718L  /**< \ingroup err
        Missing or incorrect configuration of external mode */
#define PI_CNTR_EXTERNAL_MODE_CYCLETIME_INVALID__719 719L
#define PI_CNTR_EXTERNAL_MODE_CYCLETIME_INVALID 719L  /**< \ingroup err
        External mode cycletime invalid */
#define PI_CNTR_BRAKE_ACTIVATED__720 720L
#define PI_CNTR_BRAKE_ACTIVATED 720L  /**< \ingroup err
        Brake is activated */
#define PI_CNTR_DRIVE_STATE_TRANSITION_ERROR__725 725L
#define PI_CNTR_DRIVE_STATE_TRANSITION_ERROR 725L  /**< \ingroup err
        Drive state transition error */
#define PI_CNTR_SURFACEDETECTION_RUNNING__731 731L
#define PI_CNTR_SURFACEDETECTION_RUNNING 731L  /**< \ingroup err
        Command not allowed while surface detection is running */
#define PI_CNTR_SURFACEDETECTION_FAILED__732 732L
#define PI_CNTR_SURFACEDETECTION_FAILED 732L  /**< \ingroup err
        Last surface detection failed */
#define PI_CNTR_FIELDBUS_IS_ACTIVE__733 733L
#define PI_CNTR_FIELDBUS_IS_ACTIVE 733L  /**< \ingroup err
        Fieldbus is active and is blocking GCS control commands */
...
#define PI_CNTR_ERROR_IN_MACRO 1012L  /**< \ingroup err
        Error occured during macro execution */
...
#define PI_CNTR_MAX_MOTOR_OUTPUT_REACHED 1025L  /**< \ingroup err
        Maximum motor output reached */
...
#define PI_CNTR_FREQU_ANALYSIS_FAILED 5300L  /**< \ingroup err
        Frequency analysis failed */
#define PI_CNTR_FREQU_ANALYSIS_RUNNING__5301 5301L
#define PI_CNTR_FREQU_ANALYSIS_RUNNING 5301L  /**< \ingroup err
        Another frequency analysis is running */
...
#define COM_SOCKET_HOST_NOT_FOUND -62L  /**< \ingroup err
        Host not found */
#define COM_DEVICE_CONNECTED__MINUS63 -63L
#define COM_DEVICE_CONNECTED -63L  /**< \ingroup err

...
typedef int (PI_FUNC_DECL * PFPI_TryConnectRS232)(int port, int baudrate);
typedef int (PI_FUNC_DECL * PFPI_TryConnectUSB)(const char* szDescription);
typedef BOOL (PI_FUNC_DECL * PFPI_IsConnecting)(int threadID, BOOL* bCOnnecting);
typedef int (PI_FUNC_DECL * PFPI_GetControllerID)(int threadID);
typedef BOOL (PI_FUNC_DECL * PFPI_CancelConnect)(int threadID);
...
typedef int (PI_FUNC_DECL * PFPI_OpenRS232DaisyChainByDevName)(const char* szDevName, int iBaudRate, int* pNumberOfConnectedDaisyChainDevices, char* szDeviceIDNs, int iBufferSize);
#endif
...
typedef BOOL (PI_FUNC_DECL * PFPI_GetInterfaceDescription)(int ID, char* szBuffer, int iBufferSize);

typedef void (PI_FUNC_DECL * PFPI_SetConnectTimeout)(int timeoutInMS);
typedef void (PI_FUNC_DECL * PFPI_EnableBaudRateScan)(BOOL enableBaudRateScan);
...
typedef BOOL (PI_FUNC_DECL * PFPI_EAX)(int ID, const char* szAxes, const BOOL* pbValueArray);
typedef BOOL (PI_FUNC_DECL * PFPI_qEAX)(int ID, const char* szAxes, BOOL* pbValueArray);
...
typedef BOOL (PI_FUNC_DECL * PFPI_qFPH)(int ID, const char* szAxes, double* pdValueArray);
typedef BOOL (PI_FUNC_DECL * PFPI_FPH)(int ID, const char* szAxes);
...
typedef BOOL (PI_FUNC_DECL * PFPI_qCTV)(int ID, const char* szAxes, double* pdValarray);
typedef BOOL (PI_FUNC_DECL * PFPI_CTV)(int ID, const char* szAxes, const double* pdValarray);
typedef BOOL (PI_FUNC_DECL * PFPI_CTR)(int ID, const char* szAxes, const double* pdValarray);
typedef BOOL (PI_FUNC_DECL * PFPI_qCAV)(int ID, const char* szAxes, double* pdValarray);
typedef BOOL (PI_FUNC_DECL * PFPI_qCCV)(int ID, const char* szAxes, double* pdValarray);
typedef BOOL (PI_FUNC_DECL * PFPI_qCMO)(int ID, const char* szAxes, int* piValArray);
typedef BOOL (PI_FUNC_DECL * PFPI_CMO)(int ID, const char* szAxes, const int* piValArray);
...
typedef BOOL (PI_FUNC_DECL * PFPI_ADD)(int ID, const char* szVariable, double value1, double value2);
typedef BOOL (PI_FUNC_DECL * PFPI_CPY)(int ID, const char* szVariable, const char* szCommand);

/////////////////////////////////////////////////////////////////////////////
// E-754K001 commands
typedef BOOL (PI_FUNC_DECL * PFPI_STD)(int ID, int tableType, int tableID, const char* data);
typedef BOOL (PI_FUNC_DECL * PFPI_RTD)(int ID, int tableType, int tableID, const char* name);
typedef BOOL (PI_FUNC_DECL * PFPI_qRTD)(int ID, int tableType, int tableID, int infoID, char* buffer, int bufsize);
typedef BOOL (PI_FUNC_DECL * PFPI_qLST)(int ID, char* buffer, int bufsize);
typedef BOOL (PI_FUNC_DECL * PFPI_DLT)(int ID, char* name);
...
typedef BOOL (PI_FUNC_DECL * PFPI_qCMN)(int ID, const char* szAxes, double* pdValueArray);
typedef BOOL (PI_FUNC_DECL * PFPI_qCMX)(int ID, const char* szAxes, double* pdValueArray);
...
typedef BOOL (PI_FUNC_DECL * PFPI_WAV_NOISE)(int ID, int iWaveTableId, int iAddAppendWave, double dAmplitudeOfWave, double dOffsetOfWave,int iSegmentLength);
typedef BOOL (PI_FUNC_DECL * PFPI_WAV_SWEEP)(int ID, int  iWaveTableId, int iAddAppendWave, unsigned int iStarFequencytValueInPoints, unsigned int iStopFrequencyValueInPoints, unsigned int nLengthOfWave, double dAmplitudeOfWave, double dOffsetOfWave);
...
typedef BOOL (PI_FUNC_DECL * PFPI_qWGI)(int ID, const int* piWaveGeneratorIdsArray, int* piValueArray, int iArraySize);
typedef BOOL (PI_FUNC_DECL * PFPI_qWGN)(int ID, const int* piWaveGeneratorIdsArray, int* piValueArray, int iArraySize);
typedef BOOL (PI_FUNC_DECL * PFPI_qWGS)(int ID, int iWaveGeneratorId, const char* szItem, char* buffer, int bufferSize);
...
typedef BOOL (PI_FUNC_DECL * PFPI_TWE)(int ID, const int* piWaveTableIdsArray, const int* piWaveTableStartIndexArray, const int* piWaveTableEndIndexArray, int iArraySize);
typedef BOOL (PI_FUNC_DECL * PFPI_qTWE)(int ID, const int* piWaveTableIdsArray, int* piWaveTableStartIndexArray, int* piWaveTableEndIndexArray, int iArraySize);
...
typedef BOOL (PI_FUNC_DECL * PFPI_TRI)(int ID, const int* piTriggerInputIds, const BOOL* pbTriggerState, int iArraySize);
typedef BOOL (PI_FUNC_DECL * PFPI_qTRI)(int ID, const int* piTriggerInputIds, BOOL* pbTriggerState, int iArraySize);
typedef BOOL (PI_FUNC_DECL * PFPI_CTI)(int ID, const int* piTriggerInputIds, const int* piTriggerParameterArray, const char* szValueArray, int iArraySize);
typedef BOOL (PI_FUNC_DECL * PFPI_qCTI)(int ID, const int* piTriggerInputIds, const int* piTriggerParameterArray, char* szValueArray, int iArraySize, int iBufferSize);
...
typedef BOOL (PI_FUNC_DECL * PFPI_qGFL)(int ID, int* piNumberOfRecordedFrequencyMeasurements);
typedef BOOL (PI_FUNC_DECL * PFPI_qGFR)(int ID, const int* piTableIdsArray, int iNumberOfTables, int iOffsetOfFirstPointInTable,  int iNumberOfValues, double** pdValueArray, char* szGcsArrayHeader, int iGcsArrayHeaderMaxSize);
typedef BOOL (PI_FUNC_DECL * PFPI_WFR)(int ID, const char *szAxis, double dPos, int iSource, double dAmpl, double dLowFrq, double dHighFrq, int iSweepSteps, int iSweepMode, double dVelOffset);
typedef BOOL (PI_FUNC_DECL * PFPI_qWFR)(int ID, char* szBuffer, int iBufferSize);
...
typedef BOOL (PI_FUNC_DECL * PFPI_TSP)(int ID, const int* piSensorsChannelsArray, const double* pdValueArray, int iArraySize);
...
typedef BOOL (PI_FUNC_DECL * PFPI_OSMstringIDs)(int ID, const char* szAxisOrChannelIds, const double* pdValueArray);
typedef BOOL (PI_FUNC_DECL * PFPI_qOSMstringIDs)(int ID, const char* szAxisOrChannelIds, double* pdValueArray);
...
typedef BOOL (PI_FUNC_DECL * PFPI_qOSNstringIDs)(int ID, const char* szAxisOrChannelIds, int* piValueArray);
...
typedef BOOL (PI_FUNC_DECL * PFPI_FGC)(int ID, const char* szProcessIds, const double* pdScanAxisCenterValueArray, const double* pdStepAxisCenterValueArray);
typedef BOOL (PI_FUNC_DECL * PFPI_qFGC)(int ID, const char* szProcessIds, double* pdScanAxisCenterValueArray, double* pdStepAxisCenterValueArray);
typedef BOOL (PI_FUNC_DECL * PFPI_FRC)(int ID, const char* szProcessIdBase, const char* szProcessIdsCoupled);
typedef BOOL (PI_FUNC_DECL * PFPI_qFRC)(int ID, const char* szProcessIdsBase, char* szBuffer, int iBufferSize);
typedef BOOL (PI_FUNC_DECL * PFPI_qTCI)(int ID, const int* piFastAlignmentInputIdsArray, double* pdCalculatedInputValueArray, int iArraySize);
typedef BOOL (PI_FUNC_DECL * PFPI_SIC)(int ID, int iFastAlignmentInputId, int iCalcType, const double* pdParameters, int iNumberOfParameters);
typedef BOOL (PI_FUNC_DECL * PFPI_qSIC)(int ID, const int* piFastAlignmentInputIdsArray, int iNumberOfInputIds, char* szBuffer, int iBufferSize);
typedef BOOL (PI_FUNC_DECL * PFPI_FDR)(int ID, const char* szScanRoutineName, const char* szScanAxis, const double dScanAxisRange, const char* szStepAxis, const double dStepAxisRange, const char* szParameters);
typedef BOOL (PI_FUNC_DECL * PFPI_FDG)(int ID, const char* szScanRoutineName, const char* szScanAxis, const char* szStepAxis, const char* szParameters);
typedef BOOL (PI_FUNC_DECL * PFPI_FRS)(int ID, const char* szScanRoutineNames);
typedef BOOL (PI_FUNC_DECL * PFPI_FRP)(int ID, const char* szScanRoutineNames, const int* piOptionsArray);
typedef BOOL (PI_FUNC_DECL * PFPI_qFRP)(int ID, const char* szScanRoutineNames, int* piOptionsArray);
typedef BOOL (PI_FUNC_DECL * PFPI_qFRR)(int ID, const char* szScanRoutineNames, int iResultId, char* szResult, int iBufferSize);
typedef BOOL (PI_FUNC_DECL * PFPI_qFRRArray)(int ID, const char* szScanRoutineNames, const int* iResultIds, char* szResult, int iBufferSize);
typedef BOOL (PI_FUNC_DECL * PFPI_qFRH)(int ID, char* szBuffer, int iBufferSize);
...
/////////////////////////////////////////////////////////////////////////////
typedef BOOL (PI_FUNC_DECL * PFPI_KSF)(int ID, const char* szNameOfCoordSystem);
typedef BOOL (PI_FUNC_DECL * PFPI_KEN)(int ID, const char* szNameOfCoordSystem);
typedef BOOL (PI_FUNC_DECL * PFPI_KRM)(int ID, const char* szNameOfCoordSystem);
typedef BOOL (PI_FUNC_DECL * PFPI_KLF)(int ID, const char* szNameOfCoordSystem);
typedef BOOL (PI_FUNC_DECL * PFPI_KSD)(int ID, const char* szNameOfCoordSystem, const char* szAxes, const double* pdValueArray);
typedef BOOL (PI_FUNC_DECL * PFPI_KST)(int ID, const char* szNameOfCoordSystem, const char* szAxes, const double* pdValueArray);
typedef BOOL (PI_FUNC_DECL * PFPI_KSW)(int ID, const char* szNameOfCoordSystem, const char* szAxes, const double* pdValueArray);
typedef BOOL (PI_FUNC_DECL * PFPI_KLD)(int ID, const char* szNameOfCoordSystem, const char* szAxes, const double* pdValueArray);
typedef BOOL (PI_FUNC_DECL * PFPI_KSB)(int ID, const char* szNameOfCoordSystem, const char* szAxes, const double* pdValueArray);
typedef BOOL (PI_FUNC_DECL * PFPI_MRT)(int ID, const char* szAxes, const double* pdValueArray);
typedef BOOL (PI_FUNC_DECL * PFPI_MRW)(int ID, const char* szAxes, const double* pdValueArray);
typedef BOOL (PI_FUNC_DECL * PFPI_qKLT)(int ID, const char* szStartCoordSystem, const char* szEndCoordSystem, char* buffer, int bufsize);
typedef BOOL (PI_FUNC_DECL * PFPI_qKEN)(int ID, const char* szNamesOfCoordSystems, char* buffer, int bufsize);
typedef BOOL (PI_FUNC_DECL * PFPI_qKET)(int ID, const char* szTypes, char* buffer, int bufsize);
typedef BOOL (PI_FUNC_DECL * PFPI_qKLS)(int ID, const char* szNameOfCoordSystem, const char* szItem1, const char* szItem2, char* buffer, int bufsize);
typedef BOOL (PI_FUNC_DECL * PFPI_KLN)(int ID, const char* szNameOfChild, const char* szNameOfParent);
typedef BOOL (PI_FUNC_DECL * PFPI_qKLN)(int ID, const char* szNamesOfCoordSystems, char* buffer, int bufsize);
typedef BOOL (PI_FUNC_DECL * PFPI_qTRA)(int ID, const char* szAxes, const double* pdComponents, double* pdValueArray);
typedef BOOL (PI_FUNC_DECL * PFPI_qKLC)(int ID, const char* szNameOfCoordSystem1, const char* szNameOfCoordSystem2, const char* szItem1, const char* szItem2, char* buffer, int bufsize);
typedef BOOL (PI_FUNC_DECL * PFPI_KCP)(int ID, const char* szSource, const char* szDestination);


/////////////////////////////////////////////////////////////////////////////
// Trajectory
typedef BOOL (PI_FUNC_DECL * PFPI_TGA)(int ID, const int* piTrajectoriesArray, const double* pdValarray, int iArraySize);
typedef BOOL (PI_FUNC_DECL * PFPI_TGC)(int ID, const int* piTrajectoriesArray, int iArraySize);
typedef BOOL (PI_FUNC_DECL * PFPI_TGF)(int ID, const int* piTrajectoriesArray, int iArraySize);
typedef BOOL (PI_FUNC_DECL * PFPI_TGS)(int ID, const int* piTrajectoriesArray, int iArraySize);
typedef BOOL (PI_FUNC_DECL * PFPI_qTGL)(int ID, const int* piTrajectoriesArray, int* iTrajectorySizesArray, int iArraySize);
typedef BOOL (PI_FUNC_DECL * PFPI_TGT)(int ID, int iTrajectoryTiming);
typedef BOOL (PI_FUNC_DECL * PFPI_qTGT)(int ID, int* iTrajectoryTiming);

/////////////////////////////////////////////////////////////////////////////
/// Surface scan
typedef BOOL (PI_FUNC_DECL * PFPI_FSF)(int ID, const char* szAxis, double forceValue1, double positionOffset, BOOL useForceValue2, double forceValue2);
typedef BOOL (PI_FUNC_DECL * PFPI_qFSF)(int ID, const char* szAxes, double* pForceValue1Array, double* pPositionOffsetArray, double* pForceValue2Array);
typedef BOOL (PI_FUNC_DECL * PFPI_qFSR)(int ID, const char* szAxes, BOOL* pbValueArray);
...
typedef BOOL (PI_FUNC_DECL * PFPI_WriteConfigurationFromDatabaseToController)(int ID, const char* szFilter, const char* szConfigurationName, char* szWarnings, int warningsBufferSize);
typedef BOOL (PI_FUNC_DECL * PFPI_WriteConfigurationFromDatabaseToControllerAndSave)(int ID, const char* szFilter, const char* szConfigurationName, char* szWarnings, int warningsBufferSize);
typedef BOOL (PI_FUNC_DECL * PFPI_ReadConfigurationFromControllerToDatabase)(int ID, const char* szFilter, const char* szConfigurationName, char* szWarnings, int warningsBufferSize);
typedef BOOL (PI_FUNC_DECL * PFPI_GetAvailableControllerConfigurationsFromDatabase)(int ID, char* szConfigurationNames, int configurationNamesBufferSize);
typedef BOOL (PI_FUNC_DECL * PFPI_GetAvailableControllerConfigurationsFromDatabaseByType)(int ID, char* szConfigurationNames, int configurationNamesBufferSize, unsigned int configurationType);

typedef BOOL (PI_FUNC_DECL * PFPI_IsAvailable)(int ID);

/////////////////////////////////////////////////////////////////////////////
// PIRest commands
typedef BOOL (PI_FUNC_DECL * PFPI_POL)(int ID, const char* szAxes, const int* piValueArray);

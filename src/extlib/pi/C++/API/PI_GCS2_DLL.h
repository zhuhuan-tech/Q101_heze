...
void    PI_FUNC_DECL    PI_SetConnectTimeout (int timeoutInMS);
void    PI_FUNC_DECL    PI_EnableBaudRateScan (BOOL enableBaudRateScan);
...
BOOL    PI_FUNC_DECL    PI_WriteConfigurationFromDatabaseToControllerAndSave (int ID, const char* szFilter, const char* szConfigurationName, char* szWarnings, int warningsBufferSize);
...
BOOL    PI_FUNC_DECL    PI_IsAvailable (int ID);
...
/////////////////////////////////////////////////////////////////////////////
// E-754K001 commands.
BOOL PI_FUNC_DECL PI_STD  (int ID, int tableType, int tableID, const char* data);
BOOL PI_FUNC_DECL PI_RTD  (int ID, int tableType, int tableID, const char* name);
BOOL PI_FUNC_DECL PI_qRTD (int ID, int tableType, int tableID, int infoID, char* buffer, int bufsize);
BOOL PI_FUNC_DECL PI_qLST (int ID, char* buffer, int bufsize);
BOOL PI_FUNC_DECL PI_DLT (int ID, const char* name);
